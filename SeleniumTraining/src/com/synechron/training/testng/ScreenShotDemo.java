...
public class ScreenShotDemo
{
	...
	@Test
	public void loginWihtValidCreds() throws InterruptedException
	{
	...
	public void loginWithInvalidCreds() throws InterruptedException
	{
		...
		driver.findElement(By.id("username")).sendKeys("admin111");
		driver.findElement(By.name("pwd")).sendKeys("manager111");
		driver.findElement(By.id("loginButton")).click();
		Thread.sleep(3000);
		Assert.assertEquals("actiTIME - Enter Time-Track", driver.getTitle());
		WebDriverWait wait = new WebDriverWait(driver, 20);
